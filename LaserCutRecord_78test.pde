...
//parameters
String filename = "youfilehere.txt";//generate a txt file of your waveform using python wav to txt, and copy the file name here
float rpm = 78.26;//16.66, 33.3,45, 78.26
float samplingRate = 27802.6;//44100/22050//sampling rate of incoming audio
float dpi = 1200;//dpi of cutter
int cutterWidth = 11;//width of laser cutter bed in inches
int cutterHeight = 11;//height of laser cutter bed in inches
float amplitude = 8;//10/in pixels
float spacing = 2;//8//10//space between grooves (in pixels)
...
float diameter = 9.88;//diameter of record in inches
float innerHole = 0.286;//diameter of center hole in inches
float innerRad = .75;//1.88//radius of innermost groove in inches
float outerRad = 4.85;//4.75radius of outermost groove in inches
boolean cutlines = true;//cut the inner and outer perimeters
int numGroovesPerFile = 5;//500//20//many lasers will choke if you send them all the data at once, this number spits the cutting path into several files that can be sent to the laser cutter in series, decrease this number to lower the amount of data on each section
